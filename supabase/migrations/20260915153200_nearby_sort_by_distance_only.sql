...
comment on function public.get_public_nearby_businesses(bigint, double precision, double precision, bigint[], integer) is
  'Returns published nearby places ordered strictly by distance; highlighted campaigns do not affect proximity order.';
