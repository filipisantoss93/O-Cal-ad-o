...
comment on function public.get_public_nearby_businesses(
  ...
  bigint[],
  integer
) is 'Retorna estabelecimentos públicos ordenados estritamente por distância quando há coordenadas; campanhas pagas permanecem identificadas, mas não alteram a ordem de proximidade.';
