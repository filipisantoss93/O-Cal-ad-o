...
export function FeaturedBusinesses() {
  ...
  return (
    ...
    >
      <div
        className="grid grid-cols-2 gap-2.5 sm:grid-cols-3 sm:gap-4 lg:grid-cols-4 xl:grid-cols-5"
        ...
        {displayed.map((business) => (
          ...
          >
            <BusinessCard
              business={business}
              compact
              imageSizes="(max-width: 640px) 46vw, (max-width: 1024px) 30vw, (max-width: 1280px) 25vw, 20vw"
            />
          </div>
        ))}
      </div>
